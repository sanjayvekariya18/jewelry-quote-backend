export { default as UserMaster } from "./userMaster.model";
export { default as Category } from "./category.model";
export { default as SubCategory } from "./subCategory.model";
export { default as UserPermissions } from "./userPermission.model";
export { default as PermissionMaster } from "./permissionMaster.model";
...
import { UserPermissionsAttributes, UserPermissionsInput, UserPermissionsOutput } from "./userPermission.model";
import { PermissionMasterAttributes, PermissionMasterInput, PermissionMasterOutput } from "./permissionMaster.model";
...
export {
	...
	PermissionMasterAttributes,
	PermissionMasterInput,
	PermissionMasterOutput,
	CategoryAttribute,
	CategoryInput,
	CategoryOutput,
